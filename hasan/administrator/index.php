    ...
    <div class="row">
      <div class="col">
        <div class="card" style="width: 10rem;">
          <img src="../barang.png" class="card-img-top" alt="..." height="100px" width="300px">
          <div class="card-body">
            <p class="card-text">
      ...
      <div class="col">
        <div class="card" style="width: 10rem ;">
          <img src="../pembeli.png" class="card-img-top" alt="..." height="100px" width="300px">
          <div class="card-body">
            <p class="card-text">
              <button type="button" class="btn btn-primary">
      ...
      <div class="col">
        <div class="card" style="width: 10rem;">
          <img src="../pelanggan.jpg" class="card-img-top" alt="..." height="100px" width="300px">
          <div class="card-body">
            <p class="card-text">
              <button type="button" class="btn btn-primary">
